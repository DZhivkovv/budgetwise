    ...
    <main className='g_items-in-a-row g_items-in-a-row--flex-wrap--nowrap g_height-90'>
      ...
      <section className="g_left-section">
        <div>
          ...
          <p className="g_subtitle">Enter your details to access your dashboard.</p>

          <LoginForm />
          
          <div className='g_page-footer-link'>
            Don't have an account?{' '}
            <Link to='/register' className='g_link g_link--color--black'>Register</Link>
          </div>
